...
botoncondena = tk.Button(root, text="Recargo de Prestaciones Condenatoria", command=lambda: [opt.place_forget(), numerodelmodelo(1)], width=30)
botonabsolucion = tk.Button(root, text="Recargo de Prestaciones Estimatoria", command=lambda: [opt.place(x=112, y=320), numerodelmodelo(2)], width=30)
botoncondena.place(x=60, y=20)
botonabsolucion.place(x=60, y=50)
